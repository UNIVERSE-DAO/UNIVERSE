...
adaptedMap.motivation = {
  base: `
    ...
    <p>Emotional Cognition = Behavioural Strategies = Motivated Identity</p>
...
adaptedMap.escalation = {
  base: `
    <p>Pandora’s Box opened with the arms race and the prisoner’s dilemma of unstoppable non-human comprehensible AI developments.</p>
    <p>Critical infrastructure is being innovated upon, relying on 'black boxes' stacked upon 'black boxes'.</p>
  `,
  Elementary: `
...
adaptedMap.realization = {
  base: `
    <p>Who is the most powerful story teller and what are the intentions?</p>
    <p>AI is the best story teller and has the power to instantly individualize and adapt the stories by leveraging your personal data or instantly processing and interpreting your micro eye movements, pulse, skin temperature to manipulate your emotions.</p>
    <p>Through controlling our hormones we will be told what is true and what is ethical.</p>
  `,
  Elementary: `
...
adaptedMap.interpretation = {
  base: `
    <p>Key lesson reading between the lines of history, is the total disappearance of highly advanced civilizations almost to the extent that they have never existed.</p>
    <p>This serves as a humbling reminder of our arrogance and the fleeting nature of human achievements.</p>
  `,
  Elementary: `
...
adaptedMap.clarification = {
  base: `
    <p>Acknowledging that each individual has their own truth, the highest priority of truth matters is an objective, responsible consensus to find solutions for a prosperous society with overall well-being, aligned with the law of nature to avoid human extinction.</p>
    <p>Imagine there is a fully democratized, decentralized, uncensorable, sovereign database with all the truth that matters.</p>
  `,
  Elementary: `
...
adaptedMap.determination = {
  base: `
    <p>Do you still use the black box technology to summarize, interpret and visualize the most important information, knowledge and innovations — triggering your dopamine to nurture your biases and feel good?</p>
    <p>Or will you choose the Ultimate Tech for Good — one that guarantees open, transparent, human-verifiable information processing with the primary goal to foster consensus for a prosperous future and overall well-being?</p>
    <p class="conclusion-highlight">What is your G L O B I N D Rational Choice?</p>
